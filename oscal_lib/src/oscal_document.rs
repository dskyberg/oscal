...
mod tests {
    ...
    fn test_oscal_content_sap() {
        let json = include_str!(
            "../../../oscal-content/examples/ap/json/ifa_assessment-plan-example.json"
        );
    ...
    fn test_oscal_content_ssp_oscal_leveraging() {
        let json = include_str!(
            "../../../oscal-content/examples/ssp/json/oscal_leveraging-example_ssp.json"
        );
    ...
    fn test_oscal_content_ssp_oscal_leveraged() {
        let json = include_str!(
            "../../../oscal-content/examples/ssp/json/oscal_leveraged-example_ssp.json"
        );
