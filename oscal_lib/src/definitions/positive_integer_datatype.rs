...
/// 
/// $id: #/definitions/positive_integer_datatype
...
impl TryFrom<i64> for PositiveIntegerDatatype {
    ...
    D: de::Deserializer<'de>,
{
    ...
    match PositiveIntegerDatatype::validate(s) {
        Ok(()) => Ok(s),
